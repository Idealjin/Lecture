package com.ohgiraffers.section02.aop.xmlconfig.run;
...
import com.ohgiraffers.section02.aop.xmlconfig.model.service.OrderService;
...
public class Application {
	...
	public static void main(String[] args) throws Exception {
		...
		ApplicationContext context = new GenericXmlApplicationContext("com/ohgiraffers/section02/aop/xmlconfig/config/spring-context.xml");
