package com.ohgiraffers.section02.aop.javaconfig.run;
...
import com.ohgiraffers.section02.aop.javaconfig.model.service.OrderService;
...
ApplicationContext context = new GenericXmlApplicationContext("com/ohgiraffers/section02/aop/javaconfig/config/spring-context.xml");
		...
		do {
			...
			System.out.print("다른 메뉴를 주문하시겠습니까? (Y/N) : ");
			sc.nextLine();
