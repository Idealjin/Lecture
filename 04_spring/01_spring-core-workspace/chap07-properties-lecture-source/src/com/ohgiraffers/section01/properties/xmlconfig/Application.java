package com.ohgiraffers.section01.properties.xmlconfig;
...
public class Application {
	...
	public static void main(String[] args) {
		...
		ApplicationContext context =
				new GenericXmlApplicationContext("com/ohgiraffers/section01/properties/xmlconfig/config/spring-context.xml");
