package com.ohgiraffers.section02.prototype.xmlconfig;
...
public class Application {
	...
	public static void main(String[] args) {
		...
		ApplicationContext context = 
				new GenericXmlApplicationContext("com/ohgiraffers/section02/prototype/xmlconfig/config/spring-context.xml");
