package com.ohgiraffers.section01.singleton.xmlconfig;
...
public class Application {
	...
	public static void main(String[] args) {
		...
		ApplicationContext context =
				new GenericXmlApplicationContext("com/ohgiraffers/section01/singleton/xmlconfig/config/spring-context.xml");
