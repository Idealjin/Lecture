...
public class Application {
	...
	public static void main(String[] args) {
		...
		do {
			...
			case 4 : menuController.selectMenuByCode(inputMenuCode());
					 menuController.updateMenuByCode(updateMenu()); break;
			case 5 : menuController.selectAllMenu(); 
					 menuController.deleteMenuByCode(deleteMenu()); break;
	...
	private static Map<String, String> updateMenu() {
		...
		System.out.print("수정할 판매 상태를 입력하세요(Y,N) : ");
